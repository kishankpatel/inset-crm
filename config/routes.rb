SalesCafe::Application.routes.draw do
  ...
  match "settings/update_deal_status" => "settings#update_deal_status", :via => [:get, :post]
  ...
  match "deal_statistics_info" => "home#deal_statistics_info"
  ...
  match "deal_contacts_info" => "deals#deal_contacts_info"
  match "created_by_user"=>"deals#created_by_user"
  match "deal_location_filter"=>"deals#deal_location_filter"
  match "assigned_deal_leaderboard"=>"deals#assigned_deal_leaderboard"
  ...
  match "/deal_task_widget" => "deals#deal_task_widget"
  ...
  match "get_inactive_deals" => "deals#get_inactive_deals"
  resources :deals
  match "deals/move_deal"=>"deals#move_deal", :via => [:post],:as=>"move_deal"
  match "deals/apply_label_to_deal"=>"deals#apply_label_to_deal", :via => [:post]
  match "deals/apply_label_to_single_deal"=>"deals#apply_label_to_single_deal", :via => [:post]
  match "deals/setting"=>"deals#deal_setting", :via => [:post]
  match "get_incoming_deals"=>"deals#get_incoming_deals", :via => [:post] ,:as=>"get_incoming_deals"
  match "get_working_on_deals"=>"deals#get_working_on_deals", :via => [:post] ,:as=>"get_working_on_deals"
  match "get_won_deals"=>"deals#get_won_deals", :via => [:post] ,:as=>"get_won_deals"
  match "get_lost_deals"=>"deals#get_lost_deals", :via => [:post] ,:as=>"get_lost_deals"
  match "get_junk_deals"=>"deals#get_junk_deals", :via => [:post] ,:as=>"get_junk_deals"
  match "get_un_assigned_deals"=>"deals#get_un_assigned_deals", :via => [:post] ,:as=>"get_un_assigned_deals"
  match "get_other_deals"=>"deals#get_other_deals", :via => [:post] ,:as=>"get_other_deals"
  
  match "get_contact"=>"deals#get_contact", :via => [:post]
  match "edit_deal"=>"deals#edit_deal", :via => [:post]
  match "delete_selected_deals" => "deals#delete_selected_deals"
  match "get_qualify_deals"=>"deals#get_qualify_deals", :via => [:post] ,:as=>"get_qualify_deals"
  match "get_not_qualify_deals"=>"deals#get_not_qualify_deals", :via => [:post] ,:as=>"get_not_qualify_deals"
  match "get_deals/:org_id"=>"application#get_deals"
  match "learnmore"=>"deals#learnmore"
  match "add_contact"=>"deals#add_contact"
  match "delete_deal_con/:id"=>"deals#delete_deal_con"
  match "update_deal_ttl"=>"deals#update_deal_ttl"
  match "update_note_ttl"=>"deals#update_note_ttl"
  match "fetch_activity"=>"deals#fetch_activity"
  match "fetch_user_deals"=>"deals#fetch_user_deals"
  match "get_industry_list"=>"deals#get_industry_list"
  match "save_deal_industry"=>"deals#save_deal_industry"
  ...
  match "quick_deal"=>"deals#quick_deal"
  ...
  match "accept_deal"=>"deals#accept_assign_deal"
  match "deny_deal"=>"deals#deny_assign_deal"
  
  match "deals_woking_on/:id" =>"deals#deals_woking_on", :via => [:post]
  ...
  match "/deal_files"  =>"deals#deal_files"
  match "/deal_detail_contacts"  =>"deals#deal_detail_contacts"
 ...
 # match "contacts/add_notes"=>"contacts#add_notes", :via => [:get,:post]
  ...
  match "get_deals_won"=>"reports#get_deals_won"
