...
#*****************************************************************************************/
  ...
  skip_before_filter  :authenticate_user!, :only => [:index, :pricing, :notfound, :terms, :privacy, :security,:contact_us, :clear_cache,:api_contact_us]
