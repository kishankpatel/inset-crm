...
ActiveRecord::Schema.define(:version => 20140724094652) do
  ...
  add_index "company_contacts", ["name"], :name => "name"
  add_index "company_contacts", ["organization_id"], :name => "organization_id"
  ...
  add_index "deal_stages", ["original_id"], :name => "index_deal_stages_on_original_id"
  ...
  create_table "deals", :force => true do |t|
    ...
    t.text     "comments"
    t.integer  "is_remote",           :limit => 1, :default => 0,          :null => false
  ...
  add_index "individual_contacts", ["first_name"], :name => "first_name"
  add_index "individual_contacts", ["organization_id"], :name => "organization_id"
